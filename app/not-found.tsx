        ...
        <>
          <div className="flex flex-col items-center text-center">
            <Image
              ...
              className="h-12 w-12"
            />
            <p className="mt-6 text-[56px] text-blue-500 font-bold leading-none tracking-tight">
              404
            </p>
          ...
          <Button
            asChild
            className="mt-7 h-10 w-full bg-blue-500 text-sm font-medium text-white hover:bg-blue-700"
          >
