...
export function LoginForm() {
  ...
  return (
    <AuthShell
      ...
      footnote={
        <p>
          By continuing, you agree to the <a className="text-blue-500 underline" href="https://github.com/sagea-ai/cursus/blob/main/LICENSE">SAGEA Noncommercial License</a>. Cursus is
