...
// Sidebar account menu: one click on the identity opens profile + sign-out.
// Replaces the old split (identity link plus separate sign-out icon).
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        {collapsed ? (
          ...
          <button
            aria-label={`Account: ${displayName}`}
            className="flex w-full items-center gap-2 rounded-md px-1 py-1 text-left outline-none transition-colors hover:bg-black/[0.04] focus-visible:ring-2 focus-visible:ring-ring"
          >
